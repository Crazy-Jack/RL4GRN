...
>>>>>>> 0d19b459b955c49a484cdc025a1ad19a14330b7e
        # calculate reward
...
def make(env_name, seed_network, seed_init):
    ...
    if env_name == 'random_generate_example':
        ...
        max_action = 3  # TODO: is this right?

        # define env
        env = SimulatorEnv(coefficient, init_state, target_state, original_perturb, action_index, max_action,
                           time_limit, euler_limit, delta, eps_euler, eps_target, lambda_distance_reward)
        return env
    else:
